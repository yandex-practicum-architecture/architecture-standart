### <a name="_b7urdng99y53">Задание 3. Открытие депозитов онлайн</a>**Название задачи:** 
...
•  CRM Система Колл-Центра получает заявки на депозиты с Веб-сайта.
•  CRM Система Колл-Центра отображает информацию о заявке для Оператора Колл-Центра.
...
•  Клиент получает SMS-уведомления от SMS-шлюза.
